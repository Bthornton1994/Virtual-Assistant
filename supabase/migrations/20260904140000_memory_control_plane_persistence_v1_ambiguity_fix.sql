-- Memory control-plane v1 compatibility patch 2.
-- Qualify organization_id references that otherwise collide with the
-- persist_operational_memory returns-table output column.
