-- Memory control-plane v1 compatibility patch 3.
-- Qualify every relation column referenced by persist_operational_memory.
-- This prevents PL/pgSQL output-column name collisions.
