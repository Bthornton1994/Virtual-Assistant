import { demoLoginAction, demoPasswordLoginAction } from "@/app/actions/auth";
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-5 py-16">
      ...
      <p className="mt-2 text-sm text-muted">
        Isolated sample workspace. This is not a customer account and never shares data with production tenants.
        Password for every seeded persona: demo.
      </p>
      {error ? (
      ...
      <form action={demoPasswordLoginAction} className="mt-8 space-y-4">
