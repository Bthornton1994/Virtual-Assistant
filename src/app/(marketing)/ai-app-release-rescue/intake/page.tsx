...
import { RESCUE_REVIEW_PRICE_USD } from "@/lib/ai-app-release-rescue/constants";
  ...
  return (
    <div className="mx-auto max-w-xl px-5 py-16">
      ...
      <p className="mt-4 text-base text-ink-soft">
        This path records a local demo request. It does not charge ${RESCUE_REVIEW_PRICE_USD}, does not call Stripe,
