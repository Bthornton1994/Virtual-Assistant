...
export const CAPABILITY_DEFINITIONS = [
  ...
  },
  {
    ...
    riskClass: "medium",
    inputContractVersions: ["software-factory-packet/v1"],
    outputContractVersions: ["software-factory-handoff/v1"],
    verificationContract: { kind: "independent-review", implementation: "software-factory-run-manager/v1" },
    status: "proposed",
  },
  {
    ...
    riskClass: "high",
    inputContractVersions: ["software-factory-packet/v1", "software-factory-evidence/v1"],
    outputContractVersions: ["software-factory-verification/v1"],
    verificationContract: { kind: "deterministic", implementation: "software-factory-run-manager/v1" },
    status: "proposed",
  },
  {
    key: "software_factory_run_management",
    displayName: "Software Factory Run Manager",
    description:
    ...
    outputContractVersions: [
      ...
      "software-factory-handoff/v1",
      "software-factory-evidence/v1",
      "software-factory-receipt/v1",
    ],
    verificationContract: { kind: "native", implementation: "software-factory-run-manager/v1" },
    status: "active",
  },
  {
