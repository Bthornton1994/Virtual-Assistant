...
- Strategic thesis clarifies that executor interchangeability extends to frameworks, context systems, providers, and supporting runtimes.
- `docs/CAPABILITY-SOVEREIGNTY.md` becomes the canonical doctrine.
...
```text
PR #14 merge after explicit owner authorization
...
- CS-12 should be informed by Step 3E, not invented ahead of it;
